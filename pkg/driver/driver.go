...
// Name - driver name
var Name = "nexentastor-csi-driver-block.nexenta.com"
...
// go build -ldflags "-X github.com/Nexenta/nexentastor-csi-driver-block/pkg/driver.Commit=..."
var Commit string

// DateTime - driver build datetime, to set commit set flags:
// go build -ldflags "-X github.com/Nexenta/nexentastor-csi-driver-block/pkg/driver.DateTime=..."
var DateTime string
